...
<section class="text-white bg-gray-900 bg-opacity-90 p-2 absolute bottom-2 left-2 text-sm opacity-50">
    {#if show }
    ...
    {:else}
        <p class="cursor-pointer" on:click={toggle}>Debug<span class="ml-4">⬆️</span></p>
    {/if}
</section>
